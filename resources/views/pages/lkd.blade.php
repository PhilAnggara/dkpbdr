...
@section('title', 'Laporan Kunjungan Debitur')
  ...
  <div class="page-title mb-4">
    <div class="row">
      <div class="col-12 col-md-6">
        <h3>Laporan Kunjungan Debitur</h3>
      </div>
      <div class="col-12 col-md-6">
        ...
        <table class="table table-striped table-hover text-center" id="table1">
          <thead>
            <tr>
              ...
              <th class="text-center">No. LKD</th>
              <th class="text-center">LKD</th>
...
@include('includes.modals.modal-dokumen', ['type' => 'lkd', 'modalTitle' => 'LKD'])
@endsection
